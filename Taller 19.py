...
print('La desviación estandar es: (x) {}'.format(resultado))

def desviacion_estandar2(valores,media):
    suma = 0
    for valor in valores:
        suma += (valor - media) ** 2
...
if __name__ == "__main__":
    numeros = [0.2, 0.6, 1.6, 3.5, 5.5, 9.1, 13.5]

    media = calcular_media(numeros)
    resultado = desviacion_estandar2(numeros, media)

    print('La desviación estandar 2 es: (y) {}'.format(resultado))
